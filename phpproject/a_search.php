...
<body>
        <div id="main">
              ...
              <form action="includes/a_search.inc.php" method="post">
          ...
          <div class="middle">
            <?php
                    ...
                    {
                     echo " 
                            <a href='includes/read.php?filename=".$row['id']."'download class='btn'><i class='fa fa-download'></i></a>
                            <a href='includes/delete.inc.php?id=".$row['id']."'class='trash'><i class='fa fa-trash' aria-hidden='true'></i></a>
                            <a href='includes/read.php?filename=".$row['id']."'>
                            <div class='content'>
                                    <h2>".$row['title']."</h2>
